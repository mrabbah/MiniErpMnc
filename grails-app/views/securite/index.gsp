...
<html lang="en" class="login_page">
  <head>
    ...
    <title>MAROC NUMERIC CLUSTER - Login Page</title>
  ...
  <body>
    ...
    <div class="login_box">
      ...
      <form action="securite/login" method="post" id="login_form">
<!--        <div class="top_b">Accèder au Système de Labellisation</div>                    -->
        <g:if test="${flash.message}">
          <div class="alert  alert-login" style="color: green;">
            ${flash.message}
          </div>
        </g:if>
        <g:else>
...
<!--          <div class="formRow clearfix">
            <label class="checkbox"><input type="checkbox" /> Rester connecté</label>
          </div>-->
        </div>
        <div class="btm_b clearfix">
          <button class="btn btn-inverse pull-right" type="submit">Se connecter</button>                    
          <g:link controller="inscription" action="index" class="btn">S'inscrire</g:link>          
        </div>  
      </form>
